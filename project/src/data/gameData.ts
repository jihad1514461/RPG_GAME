...
export const initialGameData: GameData = {
  classes: {
    ...
    "mage": {
      ...
      elementalRequirements: ['Fire', 'Water', 'Air'],
      reputation: 1,
      gold: 100,
      description: "A scholar of arcane magic and elemental forces",
      maxLevel: 20,
      canChangeTo: ['archmage', 'elementalist']
    },
    "rogue": {
      id: "rogue",
      name: "Rogue",
      ...
      elementalRequirements: ['Dark', 'Neutral'],
      reputation: 0,
      gold: 75,
      description: "A stealthy character who relies on cunning and agility",
      maxLevel: 20,
      canChangeTo: ['assassin', 'shadowdancer']
    },
    "cleric": {
      id: "cleric",
      name: "Cleric",
    ...
    "archmage": {
      ...
      elementalRequirements: ['Fire', 'Water', 'Air', 'Earth'],
      reputation: 2,
      gold: 0,
  ...
  classRequirements: {
    ...
    "archmage": {
      requiredStats: { magic: 4, intelligence: 3, reputation: 2 },
      requiredLevel: 20,
      requiredElements: ['Fire', 'Water', 'Air', 'Earth'],
      description: "A master of all elemental magics and ancient knowledge"
    }
  },
  items: {
    ...
    "fire_staff": {
      ...
      effects: { magic: 2, intelligence: 1 },
      value: 120,
      sellValue: 60,
      rarity: "common",
      element: "Fire"
    ...
    "scholar_robes": {
      ...
      effects: { intelligence: 2, magic: 1 },
      value: 80,
      sellValue: 40,
      rarity: "common",
      element: "Neutral"
  ...
  skills: {
    ...
    "vitality_boost": {
      ...
      type: "passive",
      effects: { vitality: 1, maxHearts: 2 },
      requirements: {
        level: 8,
        stats: { vitality: 4 }
      }
  ...
  monsters: {
    "goblin": {
      ...
      dropTable: {
        items: [
          { itemId: "health_potion", chance: 0.3, quantity: 1 },
          { itemId: "gold_coins", chance: 0.6, quantity: 15 }
        ],
        equipment: [
      ...
      classRewards: [
        { className: "warrior", bonusXP: 10, bonusReputation: 1 },
        { className: "all", bonusXP: 5 }
      ],
      spellUnlocks: []
    },
    "orc_warrior": {
      ...
      dropTable: {
        items: [
          { itemId: "health_potion", chance: 0.4, quantity: 2 },
          { itemId: "gold_coins", chance: 0.7, quantity: 25 }
        ],
        equipment: [
      ...
      classRewards: [
        { className: "warrior", bonusXP: 15, bonusReputation: 1 },
        { className: "knight", bonusXP: 20, bonusReputation: 2 },
        { className: "all", bonusXP: 8 }
      ],
      spellUnlocks: []
    }
  },
  villains: {
    "dark_lord": {
      ...
      element: "Dark",
      spells: ["dark_bolt", "shadow_shield", "drain_life"],
      weaknesses: ["Light"],
      immunities: ["Dark"],
      ai: {
        threatThreshold: 50,
      ...
      dropTable: {
        items: [
          { itemId: "legendary_gem", chance: 1.0, quantity: 1 },
          { itemId: "gold_coins", chance: 1.0, quantity: 500 }
        ],
        equipment: [
          { itemId: "dark_sword", chance: 0.8 }
        ]
      },
      classRewards: [
        { className: "knight", bonusXP: 100, bonusReputation: 10 },
        { className: "cleric", bonusXP: 120, bonusReputation: 15 },
        { className: "all", bonusXP: 75, bonusReputation: 5 }
      ],
      spellUnlocks: ["holy_light", "divine_protection"]
    }
  },
  races: {
    "Human": { 
  ...
  stories: {
    "The Cursed Forest": {
      "intro": {
        ...
        choices: [
          {
            text: "Enter the forest boldly with sword drawn",
            next_node: "forest_entrance_bold",
            effects: { xp: 15, reputation: 1 },
            require: { strength: 2 }
          },
          {
            text: "Study the forest edge with scholarly attention",
            next_node: "forest_study",
            effects: { xp: 10, intelligence: 1 },
            require: { intelligence: 2 }
          },
          {
            text: "Use magic to sense the forest's aura",
            next_node: "forest_magic_sense",
            effects: { xp: 12, magic: 1 },
            require: { magic: 2 }
          },
          {
            text: "Approach cautiously, relying on your vitality",
            next_node: "forest_cautious",
            effects: { xp: 8, hearts: 1 }
          }
        ]
      },
      "forest_entrance_bold": {
        id: "forest_entrance_bold",
        title: "Bold Entry",
        text: "You stride confidently into the forest, your weapon gleaming. Your boldness attracts attention - a shadow wolf emerges from the darkness, its eyes glowing with malevolent intelligence!",
        type: "combat",
        tags: ["forest", "combat", "wolf"],
        battle: true,
        monster: "shadow_wolf",
        choices: [
          {
            text: "Victory! The wolf falls to your blade. Continue deeper into the forest.",
            next_node: "forest_deeper",
            effects: { xp: 25, gold: 30, reputation: 1 }
          },
          {
            text: "Retreat after the fierce battle, wounded but alive.",
            next_node: "forest_retreat",
            effects: { hearts: -2, gold: 10 }
          }
        ]
      },
      "forest_study": {
        ...
        text: "Your careful study reveals ancient runes carved into the trees. The magical symbols pulse with faint light, and your intelligence allows you to decipher their meaning - they speak of a hidden treasure deeper in the forest, guarded by ancient magic.",
        type: "story",
        tags: ["forest", "magic", "treasure"],
        battle: false,
        choices: [
          {
            text: "Follow the runes deeper into the forest",
            next_node: "ancient_shrine",
            effects: { xp: 20, magic: 1 }
          },
          {
            text: "Mark the location and seek safer paths",
            next_node: "safe_path",
      ...
      "forest_magic_sense": {
        id: "forest_magic_sense",
        title: "Magical Perception",
        text: "Your magical senses tingle as you extend your awareness into the forest. You feel powerful enchantments woven into the very trees, and detect the presence of magical creatures nearby. The forest seems to respond to your magical nature.",
        type: "story",
        tags: ["forest", "magic", "perception"],
        battle: false,
        choices: [
          {
            text: "Commune with the forest's magical essence",
            next_node: "forest_communion",
            effects: { xp: 25, magic: 2, mana: 5 },
            require: { magic: 3 }
          },
          {
            text: "Seek out the magical creatures you sensed",
            next_node: "magical_encounter",
            effects: { xp: 18 }
          }
        ]
      }
      ...
      "intro": {
        ...
        choices: [
          ...
          },
          {
            ...
            effects: { xp: 15, intelligence: 1 },
            require: { intelligence: 3 }
          },
          {
